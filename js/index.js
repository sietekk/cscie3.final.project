(function($) {
  // jQuery Plugin to provide a swipable card feature
...
$(document).ready(function() {
  // Get all divs with CSS class tile per the really cool querySelectorAll method
  $(document.querySelectorAll('div.tile')).swipeToDismissCard();
});
